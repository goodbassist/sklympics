...
<div class ='row'>	
	...
	{!!Form::open(['action'=>'post','url'=>'school/newathlete','class'=>'form-horizontal','files' => true])!!}
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				{!! Form::text('dob',null,['id'=>'id-date-picker-1','data-date-format'=>'dd-mm-yyyy','class'=>'date-picker col-xs-10 col-sm-5']) !!}
				<span class="help-inline col-xs-12 col-sm-7">
					<span class="middle">E.g 20/06/1996</span>
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				{!! Form::text('height',null,['class'=>'col-xs-10 col-sm-5','id'=>'form-field-1']) !!}
				<span class="help-inline col-xs-12 col-sm-7">
					<span class="middle">1.68 m or 4.5 Ft</span>
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				{!! Form::text('weight',null,['class'=>'col-xs-10 col-sm-5','id'=>'form-field-1']) !!}
				<span class="help-inline col-xs-12 col-sm-7">
					<span class="middle">40kg</span>
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				{!! Form::text('class',null,['class'=>'col-xs-10 col-sm-5','id'=>'form-field-1']) !!}
				<span class="help-inline col-xs-12 col-sm-7">
					<span class="middle">Basic Seven</span>
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				<div class="col-xs-12 col-sm-12">
					...
					<span class="middle"><strong><i>select only two events in athletics for an athlete<i></strong</span>
				</span>						
				</div>
